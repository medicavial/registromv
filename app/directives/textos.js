        ...
        return {
            ...
            controller: function($scope, $element){
                ...
                var createPDF = function(imgData,imgData2,imgData3,qr) {
                    ...
                    doc.setFillColor(220,228,249);
                    doc.rect(81, 65, 83, 4, 'F');
                    doc.text(85, 68, 'Medicamento (sustancia activa y presentación)'); 

                    doc.setFillColor(220,228,249);
                    doc.rect(165, 65, 35, 4, 'F');
                    doc.text(169, 68, 'Forma farmacéutica');
                    ...
                    angular.forEach(info.medicamentos, function(item, index){
                        ...
                        doc.text(43, i+4, doc.splitTextToSize('Indicaciones: '+item.posologia, 166));
                    ...
                    doc.setFontSize(10);
                    doc.text(40, 290, 'Cita abierta las 24hrs en caso de continuar con molestias, favor de agendar.');
