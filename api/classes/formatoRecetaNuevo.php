...
$html="
    <table cellpadding=\"2\">
           ...
           <td align=\"center\" style=\"width:15%\" bgcolor=\"#dce4f9\">Forma farmacéutica</td>           
            ...
            $query="Select Sum_clave as clave,Sym_medicamento as medicamento, Nsum_Cantidad as cantidad, Sym_denominacion as sustancia, Sym_presentacion as susActiva, Sym_forma_far as presentacion, Nsum_obs as posologia from NotaSuministro 
          ...
          $query1="Select Ort_clave as clave, Notor_Cantidad as cantidad, Sym_denominacion as sustancia, Sym_presentacion as medicamento, Sym_forma_far as presentacion, Notor_indicaciones as posologia from NotaOrtesis 
          inner join SymioCuadroBasico on NotaOrtesis.Ort_clave=SymioCuadroBasico.Clave_producto
           ...
           if($row1= mysql_fetch_assoc($rs1)){
              do{
               $html.= "
                <tr>              
                   <td align=\"center\" >".utf8_encode($row1['clave'])."</td>
                   <td >No requiere</td>
