...
$pdf->SetFont('dejavusans', '', 8, '', true);
$pdf->Cell($w, $h, "Usuario: ".$usr, $border, $ln=1, $align, $fill, $link, $stretch, $ignore_min_height);
$html="";
$pdf->Ln(2);
$html="
...
$sql="INSERT INTO reciboParticulares (Recibo_cont,Usu_login,Exp_folio,Recibo_fecExp,Exp_fechAtencion,Recibo_total,Recibo_mpago) 
    Values (".$cveRecibo.",'".$usr."','".$fol."',now(),'".$fecRegistro."',".$total.",".$facPago.")";
//echo $sql;
