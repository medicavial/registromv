...
$query="Select Exp_nombre, Exp_paterno, Exp_materno, Exp_fechaNac, Exp_edad, Exp_meses, Exp_sexo, Rel_clave, Ocu_clave, Edo_clave, Exp_mail, Exp_telefono, Exp_fecreg From Expediente Where Exp_cancelado=0 and Exp_folio='".$fol."'";
...
$query="SELECT Subsum_clave , Sum_nombre, Subsum_obs, Subsum_cantidad FROM SubSuministros inner Join Suministro on Suministro.Sum_clave =SubSuministros.Sum_clave Where Exp_folio='".$fol."' and Sub_cons=".$Subcons;
$rs=mysql_query($query,$conn);
       ...
       <table cellspacing=\"1\" >
           <tr>
             ...
             do{
                 $html1="<tr>
                              <td align=\"center\">".utf8_encode($row['Subsum_cantidad'])."</td>
                              <td>".utf8_encode($row['Sum_nombre'])."</td>
                              <td>".utf8_encode($row['Subsum_obs'])."</td>
                         </tr>";
                 $html2=$html2.$html1;
...
$pdf->Ln(2);
 ...
 $query="SELECT Subort_clave, Ort_nombre, Ortpre_nombre, Subort_cantidad , Subort_indicaciones  FROM SubOrtesis inner Join Ortesis on Ortesis.Ort_clave=SubOrtesis.Ort_clave inner Join  Ortpresentacion on Ortpresentacion.Ortpre_clave=SubOrtesis.Ortpre_clave Where Exp_folio='".$fol."' and Sub_cons=".$Subcons;
    $rs=mysql_query($query,$conn);
       ...
       <table cellspacing=\"1\" >
           ...
           <tr>
             ...
             do{
                 $html1="<tr>
                             <td align=\"center\">".utf8_encode($row['Subort_cantidad'])."</td>
...
switch ($mes){
    ...
    $pdf->output("RCS_".$Subcons."_".$fol.".pdf",'D');
