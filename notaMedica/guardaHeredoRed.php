...
$query="Select Max(FamE_clave)+1 As Cons From FamEnfermedadRed where Exp_folio='".$fol."' and Not_clave='".$Not."'";
...
if($cons==null || $cons=='')$cons=1;
    ...
    $query="Insert into FamEnfermedadRed(FamE_clave,Exp_folio, Enf_clave, Fam_clave, Est_clave, FamE_obs, Not_clave) 
        Values('".$cons."','".$fol."',".$IdEnfermedad.",".$IdFamiliar.",".$IdEstatus.",'".$ObsHeredo."','".$Not."');";
